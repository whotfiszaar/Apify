...
**No cloud sync. No telemetry. No subscriptions.** Just a clean, powerful tool that runs entirely on your machine.

## Features
- Variable system with `${variable}` syntax and hover-to-edit popups
...
## Download
Download the standalone Windows executable from the [releases page](./release-builds/).
